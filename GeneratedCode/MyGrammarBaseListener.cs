...
public partial class MyGrammarBaseListener : IMyGrammarListener {
	...
	public virtual void EnterProg([NotNull] MyGrammarParser.ProgContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MyGrammarParser.prog"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitProg([NotNull] MyGrammarParser.ProgContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="MyGrammarParser.stat"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterStat([NotNull] MyGrammarParser.StatContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MyGrammarParser.stat"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitStat([NotNull] MyGrammarParser.StatContext context) { }
	/// <summary>
