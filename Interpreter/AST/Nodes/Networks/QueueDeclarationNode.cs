...
public class QueueDeclarationNode(int lineNumber, SingleIdentifierNode identifier, ExpressionNode service, ExpressionNode capacity, ExpressionNode numberOfServers, IEnumerable<MetricNode> metrics) : NetworkNode(lineNumber, identifier, metrics)
{
